...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'jmose_command_scheduler.command_parser' => 'getJmoseCommandScheduler_CommandParserService',
            'jmose_command_scheduler.form.type.command_choice' => 'getJmoseCommandScheduler_Form_Type_CommandChoiceService',
        ...
        $this->aliases = array(
            ...
            'fos_user.doctrine_registry' => 'doctrine_mongodb',
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Doctrine\Bundle\MongoDBBundle\CacheWarmer\ProxyCacheWarmer($this), 1 => new \Doctrine\Bundle\MongoDBBundle\CacheWarmer\HydratorCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 3 => $this->get('kernel.class_cache.cache_warmer'), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 5 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 6 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array()), 7 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array())), 8 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/vendor/jmose/command-scheduler-bundle/Resources/config/doctrine') => 'JMose\\CommandSchedulerBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'JMose\\CommandSchedulerBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('JMoseCommandSchedulerBundle' => 'JMose\\CommandSchedulerBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1863a9f78c404ac90c4a22092b72b5c932cee76712008a1b5e30a0a022429e50');
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $a->setNamespace('sf2mongodb_default_1863a9f78c404ac90c4a22092b72b5c932cee76712008a1b5e30a0a022429e50');

        $b = new \Doctrine\Bundle\MongoDBBundle\Mapping\Driver\YamlDriver(array(($this->targetDirs[3].'/src/ProductBundle/Resources/config/doctrine') => 'ProductBundle\\Document'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/AppBundle/Document'))), 'AppBundle\\Document');
        $c->addDriver($b, 'ProductBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('AppBundle' => 'AppBundle\\Document', 'ProductBundle' => 'ProductBundle\\Document'));
    ...
    protected function getDoctrineMongodb_Odm_EventManagerService()
    {
        ...
        $instance->addEventSubscriber(new \FOS\UserBundle\Doctrine\UserListener($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater')));
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting' => '@FOSUser/Resetting/email.txt.twig'), 'from_email' => array('confirmation' => array('herpakaap@gmail.com' => 'Registration confirmation'), 'resetting' => array('herpakaap@gmail.com' => 'Registration confirmation'))));
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine_mongodb')->getManager(NULL), 'AppBundle\\Document\\User');
    }
    ...
    /**
     * Gets the 'jmose_command_scheduler.command_parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \JMose\CommandSchedulerBundle\Service\CommandParser A JMose\CommandSchedulerBundle\Service\CommandParser instance
     */
    protected function getJmoseCommandScheduler_CommandParserService()
    {
        return $this->services['jmose_command_scheduler.command_parser'] = new \JMose\CommandSchedulerBundle\Service\CommandParser($this->get('kernel'), array(0 => '_global', 1 => 'scheduler', 2 => 'server', 3 => 'container', 4 => 'config', 5 => 'generate', 6 => 'init', 7 => 'router'));
    }

    /**
     * Gets the 'jmose_command_scheduler.form.type.command_choice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \JMose\CommandSchedulerBundle\Form\Type\CommandChoiceType A JMose\CommandSchedulerBundle\Form\Type\CommandChoiceType instance
     */
    protected function getJmoseCommandScheduler_Form_Type_CommandChoiceService()
    {
        return $this->services['jmose_command_scheduler.form.type.command_choice'] = new \JMose\CommandSchedulerBundle\Form\Type\CommandChoiceType($this->get('jmose_command_scheduler.command_parser'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/jmose/command-scheduler-bundle/Resources/views'), 'JMoseCommandScheduler');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/vendor/jmose/command-scheduler-bundle/Resources/config/validation.yml')));
        $instance->enableAnnotationMapping($this->get('annotation_reader'));
        $instance->addMethodMapping('loadValidatorMetadata');
        $instance->addObjectInitializers(array(0 => $this->get('doctrine.orm.validator_initializer'), 1 => $this->get('doctrine_odm.mongodb.validator_initializer'), 2 => new \FOS\UserBundle\Validator\Initializer($this->get('fos_user.util.canonical_fields_updater'))));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'JMoseCommandSchedulerBundle' => 'JMose\\CommandSchedulerBundle\\JMoseCommandSchedulerBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'JMoseCommandSchedulerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/jmose/command-scheduler-bundle'),
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'herpakaap@gmail.com' => 'Registration confirmation',
            ),
            ...
            'jmose_command_scheduler.log_path' => false,
            'jmose_command_scheduler.lock_timeout' => false,
            'jmose_command_scheduler.monitor_mail' => array(

            ),
            'jmose_command_scheduler.send_ok' => false,
            'jmose_command_scheduler.excluded_command_namespaces' => array(
                0 => '_global',
                1 => 'scheduler',
                2 => 'server',
                3 => 'container',
